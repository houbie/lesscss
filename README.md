...
You can download Lesscss from the [maven central repository](http://central.maven.org/maven2/com/github/houbie/lesscss/0.9-less-1.4.1-SNAPSHOT/lesscss-0.9-less-1.4.1-SNAPSHOT.zip)
and un-zip it.

Or you can declare it as dependency in your project:

* Gradle, grab, grails, etc.: `build "com.github.houbie:lesscss:0.9-less-1.4.1-SNAPSHOT"`
* Maven:

        <dependency>
          <groupId>com.github.houbie</groupId>
          <artifactId>lesscss</artifactId>
          <version>0.9-less-1.4.1-SNAPSHOT</version>
        </dependency>
